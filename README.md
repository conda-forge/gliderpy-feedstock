...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gliderpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13633&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gliderpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gliderpy` can be installed with:

```
conda install gliderpy
```

It is possible to list all of the versions of `gliderpy` available on your platform with:
